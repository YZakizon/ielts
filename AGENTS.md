...
- After a pull request is merged, always remove the merged local task branch, the merged remote task branch, and any temporary worktree created for that work. Do not delete unrelated branches, worktrees, or remote branches unless explicitly asked.
